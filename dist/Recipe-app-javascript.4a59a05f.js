...
},{"regenerator-runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./config.js":"2hPh4","./helper.js":"b1fwP"}],"2hPh4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView {
    ...
    addHandleRender(handler) {
        // Reduce code repetition // use array for multiple events on same function
        [
            'hashchange',
            'load'
    ...
    #generateMarkupIngredient(item) {
        return `
            <li class="recipe__ingredient">
                ...
                <div class="recipe__quantity">${item.quantity ? new (0, _fractionJsDefault.default)(item.quantity).toFraction(true) : ''}</div>
...
//# sourceMappingURL=Recipe-app-javascript.4a59a05f.js.map
